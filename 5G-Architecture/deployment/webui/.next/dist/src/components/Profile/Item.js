  ...
  (0, _createClass3.default)(Item, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(Card, { disabled: disabled, onClick: function onClick() {
          return onView(_id);
        } }, _react2.default.createElement(Profile, null, _react2.default.createElement('div', { className: 'title' }, title), _react2.default.createElement('div', { className: 'ambr' }, ambr['downlink'] === undefined ? "unlimited" : ambr.downlink['value'] === undefined ? "unlimited" : ambr.downlink.value, ' ', ambr['downlink'] === undefined ? "unlimited" : ambr.downlink['unit'] === undefined ? "bps" : ambr.downlink.unit === 0 ? "bps" : ambr.downlink.unit === 1 ? "Kbps" : ambr.downlink.unit === 2 ? "Mbps" : ambr.downlink.unit === 3 ? "Gbps" : ambr.downlink.unit === 4 ? "Tbps" : "Unknown Unit", ' / ', ambr['uplink'] === undefined ? "unlimited" : ambr.uplink['value'] === undefined ? "unlimited" : ambr.uplink.value, ' ', ambr['uplink'] === undefined ? "unlimited" : ambr.uplink['unit'] === undefined ? "bps" : ambr.uplink.unit === 0 ? "bps" : ambr.uplink.unit === 1 ? "Kbps" : ambr.uplink.unit === 2 ? "Mbps" : ambr.uplink.unit === 3 ? "Gbps" : ambr.uplink.unit === 4 ? "Tbps" : "Unknown Unit")), _react2.default.createElement('div', { className: 'actions' }, _react2.default.createElement(_.Tooltip, { content: 'Edit', width: '60px' }, _react2.default.createElement(CircleButton, { onClick: handleEdit }, _react2.default.createElement(_edit2.default, null))), _react2.default.createElement(_.Tooltip, { content: 'Delete', width: '60px' }, _react2.default.createElement(CircleButton, { className: 'delete', onClick: handleDelete }, _react2.default.createElement(_delete2.default, null)))), disabled && _react2.default.createElement(SpinnerWrapper, null, _react2.default.createElement(_.Spinner, { sm: true })));
    }
  }]);
